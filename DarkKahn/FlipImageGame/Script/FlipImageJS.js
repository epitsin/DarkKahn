...
function drawZeroPic(num) {
    ...
    var pathC = paper.path("M54.697,29.515c0.904,0,1.868,0.049,2.898,0.149c6.27,0.612,13.52,6.353,14.404,17.353v3.661    c-0.822,10.528-8.771,23.515-32,39.808C16.771,74.192,8.823,61.206,8.001,50.678v-3.661c0.883-11,8.133-16.74,14.402-17.353    c1.03-0.101,1.994-0.149,2.898-0.149c7.244,0,10.72,3.131,14.698,7.872C43.979,32.646,47.452,29.515,54.697,29.515 M54.697,36.515    c-4.162,0-5.898,1.275-9.335,5.372l-5.361,6.39l-5.363-6.39c-3.438-4.097-5.174-5.372-9.336-5.372    c-0.682,0-1.428,0.039-2.219,0.116c-2.894,0.283-7.396,3.364-8.082,10.687v3.063c0.852,9.196,9.255,19.77,24.999,31.472    C55.745,70.15,64.148,59.577,65,50.381v-3.063c-0.688-7.323-5.19-10.405-8.085-10.688C56.125,36.554,55.379,36.515,54.697,36.515    L54.697,36.515z").attr({
        parent: 'favorite',
        'stroke-width': '0',
        'stroke-opacity': '1',
        'fill': '#000000'
